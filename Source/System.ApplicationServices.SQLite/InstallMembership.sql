...
CREATE UNIQUE INDEX IF NOT EXISTS idxUsers 
ON [aspnet_Users] ( 'LoweredUsername' , 'ApplicationId' );

CREATE INDEX IF NOT EXISTS idxUsersAppId 
ON [aspnet_Users] ( 'ApplicationId' );

CREATE UNIQUE INDEX IF NOT EXISTS idxRoles 
ON [aspnet_Roles] ( 'LoweredRoleName' , 'ApplicationId' );

CREATE UNIQUE INDEX IF NOT EXISTS idxUsersInRoles 
ON [aspnet_UsersInRoles] ( 'UserId', 'RoleId');